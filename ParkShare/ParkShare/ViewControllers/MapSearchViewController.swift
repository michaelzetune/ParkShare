...
protocol LocationSelectionDelegate : NSObjectProtocol {
...
class MapSearchViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        searchBar.sizeToFit()
        searchBar.placeholder = "Where is your parking spot?"
...
extension MapSearchViewController : MKMapViewDelegate {
    func mapView(_: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView?{
        ...
        button.addTarget(self, action: #selector(MapSearchViewController.selectSpot), for: .touchUpInside)
